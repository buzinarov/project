...
class SkLearnService:
    ...
    def filterSameMeaning(self, sentences):
        for i in range(0, len(sentences)):
            if sentences[i] == 'pets no' or sentences[i] == 'sorry no pets' or sentences[i] == 'no pet' or sentences[i]== 'nno pets':
                sentences[i] = 'no pets'
            elif sentences[i] == 'smoking no' or sentences[i] == 'absolutely no smoking' or sentences[i] == 'nno smoking':
                sentences[i] = 'no smoking'
            elif sentences[i] == 'professionally managed by' or sentences[i] == 'real estate' or sentences[
                i] == 'property management services' or sentences[i] == 'property management' or sentences[
                i] == 'full property management':
            ...
            elif sentences[i] == 'canada line' or sentences[i] == 'sky train station' or sentences[i] == 'skytrain stations' or sentences[i] == 'skytrain station and' or sentences[i] == 'sky train':
                sentences[i] = 'skytrain station'
            elif sentences[i] == 'furnished realty':
                sentences[i] = 'fully furnished'
            elif sentences[i] == 'secondary school' or sentences[i] == 'private school' or sentences[
                i] == 'secondary schools' or sentences[i] == 'elementary school' or sentences[i] == 'near school' or \
                    sentences[i] == 'near schools':
