...
from scraper.text_mining.sklearnService import SkLearnService
...
cleanSentence = ["xe2", "www", "http", "link", "code", "post", "this", "info", "contact", "to", "the", "rent",
    ...
    , "from sources", "obtained from", "you have", "for your", "rates and", "does not", "we have", "can be",
                 "is subject"
    , "and more", "british columbia", 'it is', "visit our", "of our", "owner of", "if you", "your personal", "timing",
                 "or text"
    , "has been", "and all", "you will", "apply or", "contained herein", "1st 2019", "well as", "how many", "in your",
                 "such as"
    , "prospective tenants", "but we", "you are", "set up", "x80", "x93", "v6b", "sources", "com listing", "xc2",
                 'all properties'
    , "properties listed", "or processing", "terms and", "specific location", "1020", "an agent", "com vancouver",
                 'and credit'
    ...
    , "not guaranteed", "not charge", "check required", "processing fees", "four questions", "bathrm", "pets what",
                 'us are', 'officeunique real'
    , 'side', 'only available'
                 ]
cleanExact = ["bedrooms bedroom", "bedroom bathroom", "bedrooms bathrooms", "kitchen with", "walk in", "available for",
              "move in", "not included", "for more",
              "do not", "one year", "located in", "stainless steel", "stainless steel appliances", "managed by",
              "full property"
    , "street vancouver", "high end", "room and", "vancouver and", "no smoking no", 'heart of', 'and dryer',
              'washer and'
    , 'management services', 'are subject', 'sorry no', 'pets no smoking', 'open concept', 'property is', 'is not'
    , 'views of', 'one bedroom', 'built in', 'room with', 'of vancouver', 'master bedroom', 'lots of',
              'available march', 'looking for'
                                 'kitchen and', 'available april', 'away from', 'credit check', 'in closet', 'one of',
              'an appointment', 'included in', 'smoking no pets'
    , 'and hot', 'looking for', 'kitchen and', 'perfect for', 'our website', 'for viewing', 'visit our', 'heat and',
              'april 1st', 'and hot water'
    , 'living room', 'living area', 'living space', 'square feet', 'move out', 'your private', 'suite with', 'in unit',
              'suite is'
    , 'on site', 'natural light', 'restaurants and', 'bedroom with', 'bedroom and', 'bedrooms and', 'term minimum',
              'absolutely no'
    , 'comes with', 'water and', 'is available', 'appliances and', 'march 1st', 'and west', 'availability rates',
              'plenty of'
    , 'half month', 'and large', 'month available', 'apartments for', 'equipped with', 'located at', 'housing type',
              'not all', 'suite in'
    , 'full size', 'main floor', 'located on', 'shops and', 'park and', 'or visit', 'or view', 'floor plan',
              'property with'
    , 'and full', 'have no', 'many people', 'and dining', 'fees or', 'accuracy but we', 'or obtained',
              'doubt its accuracy'
    , 'vancouver property', 'guarantee it', 'estate services', 'book an appointment', 'vancouver listings', 'us or view'
    , 'have no reason', 'bright and', 'minimum one', 'minutes away', 'and bathroom', 'just steps', 'phone show',
              'and is'
    , 'and availability', 'with large', 'april 2019', 'are not', 'vancouver furnished', 'live in', 'and shopping',
              'of natural'
    , 'is an', 'do you', 'and restaurants', 'email show', 'property details', 'book an', 'it furnished', 'us or',
              '24 hour', 'with us', '1010 west'
              ]
